...
css = '''
    /* GROWTH_SEO_SECTIONS */
    .journal-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:16px}.journal-card{background:#fff;border:1px solid #e2e8f0;border-radius:22px;padding:22px;box-shadow:0 8px 24px rgba(15,23,42,.08);text-align:left}.journal-card h3{margin:0 0 10px;color:#0f172a;font-size:18px}.journal-card p{margin:0;color:#64748b;line-height:1.75;font-size:15px}.journal-card span{display:inline-block;margin-bottom:12px;color:#334155;background:#f1f5f9;border-radius:999px;padding:7px 10px;font-size:13px;font-weight:900}.journal-card a{display:inline-flex;margin-top:16px;font-weight:950;color:#0f172a}.footer-local{max-width:900px;margin:0 auto 18px;padding:18px;border-radius:22px;background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.14);color:#e5e7eb;line-height:1.7}.footer-local b{display:block;color:#fff;margin-bottom:8px}.footer-local p{margin:6px 0;color:#cbd5e1;font-size:14px}@media(max-width:760px){.journal-grid{grid-template-columns:1fr}}
'''
